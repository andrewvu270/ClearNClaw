...
- [x] 1. Set up project structure and configuration
  ...
  - [x] 1.2 Set up Supabase client configuration and TypeScript types
  ...
  - [x] 1.3 Set up React Router with route definitions and ProtectedRoute component
...
- [x] 2. Implement validation and progress utilities
  ...
  - [x] 2.3 Create progress calculation utility (`src/utils/progress.ts`)
  ...
  - [x] 2.5 Create task filter/sort utilities (`src/utils/filters.ts`)
...
- [x] 4. Implement Supabase database schema and RPC functions
  - [x] 4.1 Create Supabase migration for profiles, big_tasks, sub_tasks, user_toys tables with Row Level Security policies
  ...
  - [x] 4.2 Create Supabase RPC function `complete_subtask_and_check` for atomic sub-task completion + coin award
...
- [x] 5. Implement service layer
  - [x] 5.1 Implement Agent Service (`src/services/agentService.ts`)
  ...
  - [x] 5.2 Implement Task Service (`src/services/taskService.ts`)
  ...
  - [x] 5.7 Implement Claw Machine Service (`src/services/clawMachineService.ts`)
    - `awardToy` — inserts into user_toys (toys fetched from R2 via toyCache)
    - _Requirements: 3.3_
  - [ ]* 5.8 Write property test for toy collection grows on win (Property 6)
    - **Property 6: Toy Collection grows on win**
    - **Validates: Requirements 3.3**
  - [x] 5.9 Implement Profile Service (`src/services/profileService.ts`)
...
- [x] 7. Implement shared UI components
  - [x] 7.1 Build `CircularProgressEmoji` component
  ...
  - [x] 7.2 Build `BottomNavBar` component
  ...
  - [x] 7.3 Build `EmptyState` component
  ...
  - [x] 7.4 Build `TaskCard` component
  ...
  - [x] 7.5 Build `SubTaskItem` component
  ...
  - [x] 7.6 Build `TaskInputForm` component with voice input
...
- [x] 8. Implement pages
  - [x] 8.1 Build `SignInPage` with Three.js animated background
    ...
    - _Requirements: 6.1, 6.2_
  - [x] 8.2 Build `TasksPage` with Active/Done tabs
  ...
  - [x] 8.3 Build `ClawMachinePage` integrating existing claw machine component
  ...
  - [x] 8.4 Build `ProfilePage` with stats and toy collection
...
- [x] 9. Implement auth flow and session management
  - [x] 9.1 Wire up Supabase auth listener for session management
...
- [x] 10. Polish and responsive design
  - [x] 10.1 Apply responsive layout across all pages (320px to 1440px)
  ...
  - [x] 10.2 Add page transition animations with Framer Motion
