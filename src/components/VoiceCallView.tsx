...
/**
 * VoiceCallView - Shows Law's voice call interface
 * Displays Law's image, real-time transcript, and end call button
...
export function VoiceCallView({
  ...
  return (
    <div className="h-full flex flex-col items-center pt-8 pb-24">
      {/* Law's avatar with status indicator */}
      ...
      {/* Name and status */}
      <h2 className="text-white text-xl font-medium mb-1">{law.name}</h2>
      ...
      <div className="flex-1 w-full max-w-sm overflow-y-auto mb-6 px-2">
        ...
        {transcripts.map((transcript) => (
          ...
          >
            {/* Law's avatar for assistant messages */}
